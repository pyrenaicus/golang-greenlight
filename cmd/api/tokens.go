...
func (app *application) createAuthenticationTokenHandler(w http.ResponseWriter, r *http.Request) {
	...
	// found, then we call app.invalidCredentialResponse() helper to send a 401
	...
	// expiry time and the scoe "authentication".
	...
	// Encode the token to JSON and send it in the response along with a 210 Created
	// status code.
