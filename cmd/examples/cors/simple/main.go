...
// of a <h1> header tag, and some javaScript which fetches the JSON from our
// GET /v1/healthcheck endpoint and writes it inside the div element with
// id="output".
const html = `
	<!DOCTYPE html>
	<html lang="en">
...
func main() {
	// Make the server address configurable at runtime via command-line flag.
